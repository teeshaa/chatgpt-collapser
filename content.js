    ...
    <ul id="question-list"></ul>
        <div id="sidebar-footer">
          <div class="footer-controls">
            <button id="load-more-btn" style="display: none;" title="Load More">Next</button>
    ...
    try {
        ...
        answers.forEach((answer, i) => {
            ...
            if (correspondingQuestion) {
                ...
                const questionData = {
                    ...
                    displayText: questionText.slice(0, 120) + (questionText.length > 120 ? '...' : ''),
                    hasImage,
                    hasCode,
                    isEmpty,
        ...
        if (loadMoreBtn) {
            if (hasMore) {
                ...
                loadMoreBtn.textContent = `Next (${pairs.length - maxItems})`;
            } else {
